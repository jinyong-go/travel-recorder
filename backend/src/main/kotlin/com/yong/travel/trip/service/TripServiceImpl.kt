...
class TripServiceImpl(
    ...
    override fun get(tripId: Long, userId: Long?): TripResponse {
    ...
    @Transactional
    override fun create(ownerId: Long, request: TripCreateRequest): TripResponse {
    ...
    @Transactional
    override fun update(tripId: Long, ownerId: Long, request: TripUpdateRequest): TripResponse {
        val trip = findTrip(tripId)
     ...
     */
    @Transactional
    override fun delete(tripId: Long, ownerId: Long) {
        val trip = findTrip(tripId)
        requireOwner(trip, ownerId)
    ...
    private fun requireOwner(trip: Trip, userId: Long) {
        ...
        requireViewable(trip, userId)
        if (trip.owner.id != userId) throw ApiException(ErrorCode.FORBIDDEN)
    }
